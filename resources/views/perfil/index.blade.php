        ...
        <div class="md:w-1/2 bg-white shadow p-6">
            <form action="{{route('perfil.store')}}" method="post" enctype="multipart/form-data" class="mt-10 md:mt-0">
                ...
                <div class="mb-5">
                    ...
                    border-red-500 @enderror" placeholder="Tu Nombre de Usuario" value="{{auth()->user()->username}}">
                    @error('username')
                ...
                <div class="mb-5">
                    ...
                    <input type="file" id="imagen" name="imagen" class="border p-3 w-full rounder-lg " value="" accept=".jpg, .jpeg, .png"/>
                </div>
